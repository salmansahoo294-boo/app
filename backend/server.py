...
from routes import auth_routes, user_routes, payment_routes, admin_routes, game_routes, wallet_routes, admin_settings_routes, wagering_routes, promotion_routes, device_routes
